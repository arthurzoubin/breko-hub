...
/**
 * I use node_modules/breko-hub by default just because
...
exec('cross-env BUILDING_DLL=true webpack --display-chunks --color --config src/config/webpack.dll.babel.js');